...
class ModelEvaluation:
    ...
    def __init__(self, model_eval_config:ModelEvaluationConfig,
                    data_validation_aftifact:DataValidationArtifact,
                     model_trainer_artifact:ModelTrainerArtifact):
        
        try:
            self.model_eval_config = model_eval_config
            self.data_validation_aftifact = data_validation_aftifact
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            valid_train_file_path = self.data_validation_aftifact.valid_train_file_path
            valid_test_file_path = self.data_validation_aftifact.valid_test_file_path
            ...
            latest_model_path = model_resolver.get_bast_model_path()
